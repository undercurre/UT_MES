...
export function Index () {
  return request.get('SimpleSOP/Index')
}

// 产品图:资源列表
export function LoadResourceProductData (routeId) {
  return request.get('SimpleSOP/LoadResourceProductData?routeId=' + routeId)
}

// 零件图:资源列表
export function LoadResourceCmpData (operationRouteId) {
  return request.get('SimpleSOP/LoadResourceCmpData?operationRouteId=' + operationRouteId)
}

// 加载作业图列表
export function LoadResourceData (operationRouteId) {
  return request.get('SimpleSOP/LoadResourceData?operationRouteId=' + operationRouteId)
}

// 获取员工信息
// eslint-disable-next-line camelcase
export function LoadEmployeeData (user_id) {
  return request.get('SimpleSOP/LoadEmployeeData', {
    params: {
      user_id
    }
  })
...
export function LoadSkillStandard (site_id) {
  return request.get('SimpleSOP/LoadSkillStandard', {
    parmas: {
      site_id
    }
  })
