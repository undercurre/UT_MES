  ...
  <custom-container>
    ...
    <div class="table-container">
      <vxe-table
        ...
        :data="mainTable"
      >
        <vxe-table-column sortable field="LOCATION" :title="$t('SpiReport._0')" />
        <vxe-table-column sortable field="ERRCODE" :title="$t('SpiReport._1')" />
        <vxe-table-column sortable field="NUM" :title="$t('SpiReport._2')" />
      </vxe-table>
    </div>
    <div class="report">
    ...
    async getLoadData () {
      ...
      if (res.Result) {
        ...
        errorCount.forEach((e) => {
          titles.push((e.LOCATION || '错误码') + '-' + e.ERRCODE)
          nums.push(e.NUM)
        })
