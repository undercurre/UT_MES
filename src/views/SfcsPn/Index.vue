...
<!--        />&nbsp;-->
        ...
        <el-button
          ...
          >{{ $t("publics.btn.reset") }}</el-button
        >
        <el-button
          type="success"
          icon="el-icon-plus"
          @click="insertEvent(-1)"
          v-if="$btnList.indexOf('SfcsPnAdd') !== -1"
      ...
      >
        ...
        >
          <template v-slot:edit="{ row }">
            <span v-show="row.DOUBLE_SIDE === 'Y'" class="green-txt">{{
              $t("SfcsPn._41")
            }}</span>
            <span v-show="row.DOUBLE_SIDE === 'N'" class="red-txt">{{
              $t("SfcsPn._42")
            }}</span>
          </template>
        </vxe-table-column>
        ...
        >
          <template v-slot:edit="{ row }">
            <span v-show="row.LEAD_FLAG === 'Y'" class="green-txt">{{
              $t("SfcsPn._41")
            }}</span>
            <span v-show="row.LEAD_FLAG === 'N'" class="red-txt">{{
              $t("SfcsPn._42")
            }}</span>
          </template>
        </vxe-table-column>
        ...
        >
          <template v-slot:edit="{ row }">
            <span v-show="row.SHIP_FLAG === 'Y'" class="green-txt">{{
              $t("SfcsPn._41")
            }}</span>
            <span v-show="row.SHIP_FLAG === 'N'" class="red-txt">{{
              $t("SfcsPn._42")
            }}</span>
          </template>
        </vxe-table-column>
        ...
        >
          <template v-slot:edit="{ row }">
            <span v-show="row.EDI_FLAG === 'Y'" class="green-txt">{{
              $t("SfcsPn._41")
            }}</span>
            <span v-show="row.EDI_FLAG === 'N'" class="red-txt">{{
              $t("SfcsPn._42")
            }}</span>
          </template>
        </vxe-table-column>
        ...
        >
          <template v-slot="{ row }">
            <el-button
              ...
              v-if="$btnList.indexOf('SfcsPnEdit') !== -1"
    ...
    <!-- 抽屉 -->
    <el-drawer :title="$t('SfcsPn._48')" :visible.sync="drawer" direction="ltr">
          ...
          >
            ...
            <el-form-item :label="$t('SfcsPn._11')">
              ...
              >
                ...
                >
                  <el-input
                    v-model="productForm.FAMILY_NAME"
                    :placeholder="$t('SfcsPn._49')"
                    clearable
                  ></el-input>
                  <el-button
                    type="primary"
                    icon="el-icon-search"
                    @click.prevent="searchProductList"
                    >{{ $t("publics.btn.search") }}</el-button
                  >
                </div>
                <el-option
            ...
            <el-form-item :label="$t('SfcsPn._17')">
              ...
              >
                <el-option
                  v-for="item in ProductStageList"
                  :key="item.value"
                  :label="item.label"
                  :value="item.value"
                /> </el-select
    ...
    >
      ...
      >
        <el-row>
          <el-col :span="12">
            <el-form-item :label="$t('SfcsPn._30')" prop="PART_NO">
              <el-input
        ...
        <el-row>
          ...
          <el-col :span="12">
            <el-form-item :label="$t('SfcsPn._12')" prop="MODEL">
              <!-- 机种下拉 -->
              <el-select
                style="width: 100%"
              ...
              >
                ...
                >
                  <el-input
                    ...
                    clearable
                    @input="searchModelList"
                    @keyup.enter.native="searchModelList"
                  ></el-input>
                  <el-button
                    type="primary"
                    icon="el-icon-search"
        ...
        <el-row>
          <el-col :span="12">
            <el-form-item :label="$t('SfcsPn._22')">
              <el-input
                v-model="editForm.WARRANTY_LIMIT"
        ...
        <el-row>
          ...
          <el-col :span="12">
            <el-form-item :label="$t('SfcsPn._29')">
              <el-select
                v-model="editForm.CATEGORY_MEANING"
