  ...
  <d2-container class="MesTongsMaintainItems"
    ...
    <template slot="header">
      <custom-container-header defaultTableType="el"
        ...
        <el-select v-model="listQuery.TONGS_TYPE"
          ...
          >
            <el-input
              v-model="s_pagination.chinese"
              @input="s_searchClick"
              placeholder="请输入工装名称关键字"
              @keyup.enter.native="s_searchClick"
            ></el-input>
            <el-button
              type="primary"
              icon="el-icon-search"
              @click.prevent="s_searchClick"
    ...
    <div class="table-container">
      <el-table v-loading="listLoading"
        ...
        <el-table-column sortable prop="ID"
                         width="150"
                         :label="$t('mtm._7')"
                         align="center"
        ...
        <el-table-column sortable width="140"
         ...
         <el-table-column sortable width="200"
                         prop="TONGS_NAME"
                        :label="$t('mtm._11')"
                         align="center"
                         :show-overflow-tooltip="true" />
        ...
        <el-table-column sortable width="300"
                         prop="ITEM_NAME"
                         :label="$t('mtm._16')"
                         align="center"
                         :show-overflow-tooltip="true" />
        <el-table-column sortable width="400"
                         prop="REMARK"
                         :label="$t('mtm._17')"
                         align="center"
                         :show-overflow-tooltip="true" />
