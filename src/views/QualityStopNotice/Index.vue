    ...
    <div style="height:100%">
      <vxe-table ref="xTable"
        ...
        <vxe-table-column sortable field="WO_NO"
                          ...
                          align="center"
                          min-width="200" />
        <vxe-table-column sortable field="PCB_PN"
        ...
        <vxe-table-column sortable field="DESCRIPTION"
                          ...
                          align="center"
                          min-width="200" />
        <vxe-table-column sortable field="TOTAL_QTY"
        ...
        <vxe-table-column sortable field="TOTAL_QTY"
                          ...
                          align="center"
                          min-width="160" />
        <vxe-table-column sortable field="CREATE_DEP_NAME"
        ...
        <vxe-table-column sortable field="AUDIT_USER"
                          :title="$t('QualityStopNotice._18')"
                          align="center"
                          min-width="100" />
        <vxe-table-column sortable field="AUDIT_CONTENT"
                          :title="$t('QualityStopNotice._44')"
                          align="center"
                          min-width="200" />
        <vxe-table-column sortable field="AUDIT_TIME"
                          :title="$t('QualityStopNotice._19')"
                          align="center"
                          min-width="200" />
        <vxe-table-column sortable field="APPROVAL_USER"
                          min-width="140"
                          :title="$t('QualityStopNotice._20')"
                          align="center" />
        <vxe-table-column sortable field="APPROVAL_CONTENT"
                          :title="$t('QualityStopNotice._45')"
                          align="center"
                          min-width="200" />
        <vxe-table-column sortable field="APPROVAL_TIME"
                          min-width="200"
      ...
      <div class="Manag-table-container">
        <vxe-table ref="xTable"
          ...
          <vxe-table-column sortable show-overflow
                            ...
                            type="radio"
                            align="center" />
          <vxe-table-column sortable prop="User_Name"
                            :label="$t('QualityStopNotice._46')"
                            align="center" />
          <vxe-table-column sortable prop="Nick_Name"
                            :label="$t('QualityStopNotice._47')"
                            align="center" />
          <vxe-table-column sortable prop="Mobile"
                            :label="$t('QualityStopNotice._48')"
                            align="center" />
          <vxe-table-column sortable prop="Work_Wechat_Id"
