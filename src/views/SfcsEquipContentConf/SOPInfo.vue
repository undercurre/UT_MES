<template>
  <d2-container>
    ...
    <div class="table-container">
      ...
      >
        <vxe-table-column sortable min-width="120" :title="$t('se_cc.sn')">
        ...
        />
        <vxe-table-column sortable field="KEEP_TYPE" min-width="150" :title="$t('se_cc.mt')">
        ...
        <vxe-table-column sortable
          ...
          :edit-render="{name: '$input', props: {readonly: true}}"
        />
        <vxe-table-column  field="ENABLE" fixed="right" min-width="100" :title="$t('se_cc.e')">
          <template v-slot="{ row }">
            <el-switch
        ...
        <vxe-table-column  field="ENABLED" fixed="right" min-width="200" :title="$t('se_cc.operate')">
          <template slot-scope="scope">
            <el-button
