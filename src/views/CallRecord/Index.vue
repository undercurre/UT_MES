  ...
  <d2-container class="CallRecord">
    ...
    <div class="CallRecord-tanble">
      <el-table stripe :sort-config="{trigger: 'cell'}"
        ...
        <el-table-column sortable :label="$t('crp.tb_1')"
                         width="80"
                         align="center"
                         fixed>
        ...
        <el-table-column sortable prop="CALL_TYPE_NAME"
                         :label="$t('crp.tb_11')"
                         align="center"
                         width="150"
                         :show-overflow-tooltip="true" />
        <el-table-column sortable prop="CALL_CONTENT"
                         ...
                         width="200"
                         :show-overflow-tooltip="true" />
        <el-table-column sortable prop="CHECKIN_TIME"
                         :label="$t('crp.tb_13')"
                         align="center"
                         width="200"
                         :show-overflow-tooltip="true" />
        <el-table-column sortable prop="CHECKIN_OPERATOR"
                         :label="$t('crp.tb_14')"
                         align="center"
                         width="150"
                         :show-overflow-tooltip="true" />
        <el-table-column sortable prop="END_TIME"
                         ...
                         width="200"
                         :show-overflow-tooltip="true" />
        <el-table-column sortable prop="END_OPERATOR"
                         :label="$t('crp.tb_16')"
                         align="center"
                         width="150"
                         :show-overflow-tooltip="true" />
        ...
        <el-table-column sortable prop="OPERATION_SITE_NAME"
                         ...
                         width="150"
                         :show-overflow-tooltip="true" />
        <el-table-column sortable :label="$t('crp.tb_19')"
                         align="center"
                         width="150"
                         fixed="right">
          <template slot-scope="scope"
    ...
    <div class="CallRecord-tanble-com">
      <el-table :data="dealWithTable"
                ...
                height="100%"
                :header-cell-style="{background:'#eef1f6',color:'#606266'}">
        <el-table-column sortable prop="HANDLER"
                         :label="$t('crp.p_1')"
                         align="center"
                         :show-overflow-tooltip="true" />
        <el-table-column sortable prop="HANDLE_TIME"
                         :label="$t('crp.p_2')"
                         align="center"
                         :show-overflow-tooltip="true" />
        <el-table-column sortable prop="HANDLE_CONTENT"
                         :label="$t('crp.p_3')"
                         align="center"
                         :show-overflow-tooltip="true" />
        <el-table-column sortable prop="HANDLE_STATUS"
                         :label="$t('crp.p_4')"
                         align="center"
                         :show-overflow-tooltip="true">
          <template slot-scope="scope">
    ...
    <div class="CallRecord-tanble-com">
      <el-table :data="NoticeTable"
                ...
                height="100%"
                :header-cell-style="{background:'#eef1f6',color:'#606266'}">
        <el-table-column sortable prop="NOTICE_TYPE"
                         :label="$t('crp.p_8')"
                         align="center"
                         :show-overflow-tooltip="true" />
        <el-table-column sortable prop="NOTICE_RECEIVER"
                         :label="$t('crp.p_9')"
                         align="center"
                         :show-overflow-tooltip="true" />
        <el-table-column sortable prop="NOTICE_CONTENT"
                         :label="$t('crp.p_10')"
                         align="center"
                         :show-overflow-tooltip="true" />
        <el-table-column sortable prop="NOTICT_TIME"
                         :label="$t('crp.p_11')"
                         align="center"
                         :show-overflow-tooltip="true" />
