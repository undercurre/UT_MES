      ...
      <div class="SfcsStoplineHistory-table">
        <vxe-table v-loading="loading"
          ...
          <vxe-table-column sortable show-overflow
                            ...
                            align="center"
                            width="150" />
          <vxe-table-column sortable field="LOCK_STATUS"
                            :title="$t('ukas._29')"
          ...
          <vxe-table-column sortable width="150"
                            ...
                            :edit-render="{ name: 'input' }"
                            align="center" />
          <vxe-table-column sortable field="INCLUDE_NDF"
                            :title="$t('ukas._41')"
                            :edit-render="{ autofocus: '.custom-input', type: 'visible' }"
                            width="150"
                            align="center">
          ...
          <vxe-table-column sortable width="150"
                            ...
                            :edit-render="{ name: 'input' }"
                            align="center" />
          <vxe-table-column sortable :title="$t('ukas._50')"
                            width="150"
                            align="center"
                            fixed="right">
            <template v-slot="{ row }">
            ...
            <div class="second-table">
              <vxe-table ref="xserDate"
                ...
                <vxe-table-column sortable width="180"
                                  ...
                                  :edit-render="{ name: 'input' }"
                                  align="center" />
                <vxe-table-column sortable width="300"
                                  field="SN"
                                  :title="$t('ukas._58')"
                                  :edit-render="{ name: 'input' }"
                                  align="center" />
