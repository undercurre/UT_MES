<template>
  <d2-container>
    ...
    <div>
      ...
      >
        <vxe-table-column sortable min-width="150" field="FEEDER_NAME" :title="$t('sfm.rack')" />
        <vxe-table-column sortable min-width="150" field="USED_COUNT" :title="$t('sfm.uc')" />
        <vxe-table-column sortable min-width="150" field="MAINTAIN_KIND" :title="$t('sfm.my')" />
        <vxe-table-column sortable min-width="150" field="MAINTAIN_BY" :title="$t('sfm.mm')" />
        <vxe-table-column sortable min-width="150" field="DESCRIPTION" :title="$t('sfm.dn')" />
        <vxe-table-column sortable min-width="150" field="MAINTAIN_TIME" :title="$t('sfm.mt')" />
        <!-- <vxe-table-column sortable field="FEEDER_NAME" :title="$t('sfm.sn')" /> -->
      </vxe-table>
    </div>
