    ...
    <template slot="header">
      <custom-container-header :isExport="false" :isExportTpl="false" :isImport="false">
        ...
        <el-button
          type="primary"
          icon="el-icon-upload2"
          @click="upLoadSimensOldMaterials"
          v-if="$btnList.indexOf('ImportAIPlacementView5') !== -1"
        >{{$t('SmtPlacementHeader._120')}}</el-button>
...
export default {
  ...
  methods: {
    ...mapMutations({
      ...
      SET_SIMENSOLD_FLAG: 'custom/materials/SET_SIMENSOLD_FLAG'
    }),
    async getIndex () {
    ...
    // 西门子旧料单上传
    upLoadSimensOldMaterials () {
      this.SET_SIMENSOLD_FLAG(true)
    },
    async getDetailData () {
