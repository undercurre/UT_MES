  ...
  <d2-container class="MesQualityInfo">
    ...
    <div class="MesQualityInfo-table-dev">
      <el-table v-loading="Loading"
        ...
        >
        <el-table-column sortable :label="$t('MesQualityInfo._91')"
                         min-width="80"
                         align="center"
                         fixed="left">
        ...
        <el-table-column sortable :label="$t('MesQualityInfo._21')"
                         align="center"
                         min-width="110"
                         fixed="left">
          <template slot-scope="scope">{{ scope.$index + 1 }}</template>
        </el-table-column>
        <el-table-column sortable prop="CHECK_TYPE_NAME"
        ...
        <el-table-column sortable prop="LINE_NAME"
                         ...
                         min-width="150"
                         :show-overflow-tooltip="true" />
        <el-table-column sortable prop="PRODUCT_DATE"
        ...
        <!--        <el-table-column sortable prop="DEPARTMENT_NAME"-->
        <!--                         :label="$t('MesQualityInfo._25')"-->
        <!--                         align="center"-->
        <!--                         min-width="150"-->
        <!--                         :show-overflow-tooltip="true" />-->
        <el-table-column sortable prop="FIRST_ITEM_TYPE"
                         :label="'首件类型'"
                         min-width="150"
                         align="center"
                         :show-overflow-tooltip="true"
                         :formatter="handleFormatterFirstItemType"></el-table-column>
        <el-table-column sortable prop="EP_STATUS"
                         :label="'环保状态'"
                         min-width="150"
                         align="center"
                         :show-overflow-tooltip="true"
        ...
        <el-table-column sortable prop="BATCH_NO"
                         ...
                         min-width="160"
                         :show-overflow-tooltip="true" />
        <el-table-column sortable prop="PCB_SIDE"
        ...
        <el-table-column sortable prop="PART_DESC"
                         ...
                         min-width="160"
                         :show-overflow-tooltip="true" />
        <el-table-column sortable prop="BATCH_QTY"
                         :label="$t('MesQualityInfo._35')"
                         align="center"
                         min-width="90"
                         :show-overflow-tooltip="true" />

        <el-table-column sortable prop="WORK_CLASS"
        ...
        <el-table-column sortable prop="WORK_SHIFTS"
        ...
        <el-table-column sortable prop="RESULT_REMARK"
                         :label="$t('MesQualityInfo._42')"
                         align="center"
                         min-width="260"
                         :show-overflow-tooltip="true" />
        <el-table-column sortable prop="CREATE_USER"
        ...
        <el-table-column sortable prop="CREATE_TIME"
                         ...
                         min-width="170"
                         :show-overflow-tooltip="true" />
        <el-table-column sortable prop="AUDIT_USER"
                         :label="$t('MesQualityInfo._45')"
                         align="center"
                         min-width="160"
                         :show-overflow-tooltip="true" />

        <el-table-column sortable prop="AUDIT_TIME"
                         :label="$t('MesQualityInfo._46')"
                         align="center"
                         min-width="160"
                         :show-overflow-tooltip="true" />
        <el-table-column sortable prop="UPDATE_USER"
                         :label="$t('MesQualityInfo._47')"
                         align="center"
                         min-width="160"
                         :show-overflow-tooltip="true" />
        <el-table-column sortable prop="UPDATE_TIME"
        ...
        <el-table-column sortable prop="RESULT_STATUS"
    ...
    <el-tabs v-model="TorikoName"
      ...
      <el-tab-pane :label="$t('MesQualityInfo._107')"
        ...
        <el-table v-loading="childLoading"
          ...
          <el-table-column sortable prop="CHECK_ITEM"
                           min-width="150"
                           :label="$t('MesQualityInfo._56')"
                           align="center"
                           :show-overflow-tooltip="true" />
          <el-table-column sortable prop="CHECK_DESC"
                           min-width="150"
                           :label="$t('MesQualityInfo._57')"
                           align="center"
                           :show-overflow-tooltip="true"></el-table-column>
          <el-table-column sortable prop="QUANTIZE_TYPE"
                           min-width="150"
          ...
          <el-table-column sortable prop="ISEMPTY"
                           min-width="150"
          ...
          <el-table-column sortable prop="RESULT_VALUE"
                           min-width="150"
          ...
          <el-table-column sortable prop="RESULT_TYPE"
                           min-width="150"
                           fixed="right"
      ...
      <el-tab-pane :label="$t('MesQualityInfo._108')"
        ...
        <!-- <div style="display: flex;height: 100%;"> -->
          <el-table :data="MaterialsTable"
            ...
            <el-table-column sortable prop="POSITION"
                             min-width="200"
                             :label="$t('MesQualityInfo._110')"
                             align="center"
                             :show-overflow-tooltip="true" />
            <el-table-column sortable :label="$t('MesQualityInfo._109')"
                             prop="PART_NO"
                             :show-overflow-tooltip="true"
                             align="center"
                             min-width="300">
            ...
            <el-table-column sortable prop="PART_DESC"
                             ...
                             align="center"
                             :show-overflow-tooltip="true" />
            <!-- <el-table-column sortable prop="VENDOR_NAME"
                           min-width="200"
                           :label="'品牌供应商'"
                           align="center"
                           :show-overflow-tooltip="true" /> -->
            <el-table-column sortable prop="TEST_VALUE"
                             min-width="150"
                             :label="'测试值'"
                             align="center"
                             :show-overflow-tooltip="true" />

            <el-table-column sortable prop="BRAND_NAME"
                             min-width="200"
            ...
            <el-table-column sortable prop="VENDOR_NAME"
                             ...
                             align="center"
                             :show-overflow-tooltip="true" />
            <el-table-column sortable prop="TENSION_VALUE"
                             min-width="150"
                             :label="'拉力值'"
                             align="center"
                             :show-overflow-tooltip="true" />
    ...
    <el-dialog width="75%"
      ...
      <div style="width: 100%">
        ...
        <el-tabs v-model="activeName" @tab-click="handleClick">
          <el-tab-pane :label="$t('MesQualityInfo._107')" name="first">
            <vxe-table
            border
            resizable
            height="365"
          ...
          >
          <vxe-table-column sortable field="CHECK_ITEM"
                                  min-width="200"
                                  :title="$t('MesQualityInfo._56')"
                                  align="center" />
                <vxe-table-column sortable field="QUANTIZE_TYPE"
                                  min-width="200"
                ...
                <vxe-table-column sortable field="ISEMPTY"
                                  min-width="200"
                ...
                <vxe-table-column sortable field="RESULT_VALUE"
                                  min-width="200"
                                  align="center"
                                  :label="$t('MesQualityInfo._64')"
          ...
          <el-tab-pane :label="$t('MesQualityInfo._108')" name="second">
          <vxe-table
            border
            resizable
            height="365"
            ...
            :edit-config="{trigger: 'click', mode: 'row', showStatus: true}"
          >
           <vxe-table-column sortable field="COMPONENT_LOCATION"
                                  min-width="200"
                                  :title="$t('MesQualityInfo._112')"
                                  align="center" />
                <vxe-table-column sortable field="PART_CODE"
                                  min-width="200"
                                  :title="$t('MesQualityInfo._109')"
                                  align="center" />
                <vxe-table-column sortable field="PART_NAME"
                                  min-width="200"
                                  :title="$t('MesQualityInfo._114')"
                                  align="center" />

                <vxe-table-column sortable field="PART_MODEL"
                                  min-width="200"
                                  :title="$t('MesQualityInfo._116')"
                                  align="center" />
                <vxe-table-column sortable field="UNIT_QTY"
                                  min-width="105"
                                  :title="$t('MesQualityInfo._117')"
                                  align="center" />

                <vxe-table-column sortable field="TEST_VALUE"
                                  min-width="130"
                                  :title="$t('测试值')"
                                  align="center"
                                  :edit-render="{ autofocus: '.custom-input', type: 'visible' }">
                ...
                <vxe-table-column sortable field="BRAND_NAME"
                                  min-width="130"
                ...
                <vxe-table-column sortable field="VENDOR_NAME"
                                  min-width="130"
                ...
                <vxe-table-column sortable field="TENSION_VALUE"
                                  min-width="120"
