<template>
  <div class="DockingStation">
    ...
    >
      ...
      <el-row   class="kanban-title">
        <el-col v-show="drawer==false" :span="5"
        ...
        <el-col v-show="drawer==false" :span="14">
      ...
      <div style="height: calc(100vh - 70px - 67px);" >
        <el-row>
          <el-col :span="6"
          :style="{'z-index':drawer?'9999':'0','position':drawer?'fixed':'static'}">
            <!-- 数据录入 -->
                ...
                <div class="block-center-content">
                  ...
                  <el-form ref="form"
                    ...
                    <el-form-item label="不良代码">
                              <BadCode  :bindData="DEFECT_CODE" @badCode="badCode" :tableWidth="300"/>
                    </el-form-item>
                  </el-form>
                </div>
          ...
          <el-col v-if="drawer==false" :span="9"
          ...
          <el-col v-if="drawer==false" :span="5"
                  style="padding-left: 15px;box-sizing: border-box">
            <!-- 信息汇总 -->
            <div class="block-center">
              <div class="kanban-wo-site-panel kanban-panel-bg"
          ...
          <el-col v-if="drawer==false" :span="4"
                  style="padding-left: 15px;box-sizing: border-box">
  ...
  <div class="esopContent">
    <div class="esopClose" @click="cloaseEsop">关闭E-SOP</div>
    <div class="esopData"><SopSimple  :routeData="routeData"/></div>
  </div>
...
export default {
  ...
  methods: {
    ...
    ESOPPreview () {
      ...
      console.log(routeData.location.query)
      const ifrmae = document.getElementById('myIframeDiv')
      // this.$nextTick(() => {
      if (ifrmae) {
        document.getElementById('myIframeDiv').contentWindow.location.reload(true)
      }
      this.EsopUrl = routeData.href
      // document.frames('myIframeDiv').document.location = routeData.href
      // })
...
.DockingStation {
  ...
  .center-centent-testmsg {
    ...
    scrollbar-width: none;overflow-x: hidden;overflow-y: auto;
