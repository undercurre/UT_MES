    ...
    <el-form class="document-form"
      ...
      <div class="overview">
        <vxe-table ref="xTable"
          ...
          <vxe-table-column sortable class="overview-checkbox"
                            type="checkbox"
                            width="80"
                            :title="$t('goods.docu._23')"></vxe-table-column>
          <vxe-table-column sortable field="HOLD_NUMBER"
                            :title="$t('goods.docu._7')"
                            width="150" />
          <vxe-table-column sortable field="SN"
                            :title="$t('goods.docu._36')"
                            width="150" />
          <vxe-table-column sortable field="CARTON_NO"
                            :title="$t('goods.docu._37')"
                            width="150" />
          <vxe-table-column sortable field="PALLET_NO"
          ...
          <vxe-table-column sortable field="WO_NO"
                            ...
                            min-width="180" />
          <vxe-table-column sortable field="COMPONENT_SN"
                            :title="$t('goods.docu._42')"
                            width="150" />
          <vxe-table-column sortable field="CUSTOMER_COMPONENT_PN"
          ...
          <vxe-table-column sortable field="OPERATION_LINE_NAME"
                            :title="$t('goods.docu._47')"
                            width="150" />
          <vxe-table-column sortable field="OPERATION_SITE_NAME"
                            :title="$t('goods.docu._48')"
                            width="150" />
          <vxe-table-column sortable field="OPERATION_NAME"
                            :title="$t('goods.docu._49')"
                            width="150" />
          <vxe-table-column sortable field="HOLD_ACTION"
                            :title="$t('goods.docu._50')"
                            width="150" />
          <vxe-table-column sortable field="CREATE_TIME"
                            :title="$t('goods.docu._51')"
                            width="150" />
          <vxe-table-column sortable field="RELEASE_CAUSE"
                            :title="$t('goods.docu._20')"
                            min-width="170" />
          <vxe-table-column sortable field="RELEASE_EMPNO"
                            :title="$t('goods.docu._52')"
                            width="150" />
          <vxe-table-column sortable field="RELEASE_TIME"
