<template>
  <d2-container>
    ...
    <div class="table-container">
      ...
      >
        <vxe-table-column sortable min-width="80" :title="$t('se_cc.sn')">
        ...
        <vxe-table-column sortable
          ...
          :edit-render="{name: '$input', props: {readonly: true}}"
        />
        <vxe-table-column sortable min-width="150" field="ENABLED" :title="$t('MesFirstCheckItems._13')">
        ...
        <vxe-table-column sortable :title="$t('plbd.tb_og')" min-width="180" align="center" fixed="right">
          <template v-slot="{ row }">
            <el-button
              type="primary"
