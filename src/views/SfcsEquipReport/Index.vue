    ...
    <div class="SfcsEquipRepairHead-MainTable">
      <vxe-table ref="xTable"
        ...
        <vxe-table-column sortable field="USER_PART_NAME"
                          :title="$t('ser.ud')"
                          :edit-render="{name: '$input', props: {readonly: true}}" />
        <vxe-table-column sortable field="ENABLE"
                          :title="$t('ser.Sort')">
          <template slot-scope="scope">
      ...
      <el-tab-pane name="first"
        ...
        <div class="col-teble">
          <el-table stripe :sort-config="{trigger: 'cell'}"
                    ...
                    highlight-current-row
                    :show-header="false">
            <el-table-column sortable label
                             width="400">
              <template slot-scope="scope">
          ...
          <el-col :span="10">
            ...
            <div class="col-teble">
              <vxe-table ref="accessoriesTable"
                         ...
                         :mouse-config="{selected: true}"
                         :edit-config="{trigger: 'click', mode: 'row', showStatus: true}">
                <vxe-table-column sortable field="COMPONENT_NAME"
                                  :title="$t('ser.an')"
                                  :edit-render="{name: '$input', props: {readonly: true}}" />
                <vxe-table-column sortable field="COMPONENT_MODEL"
                                  :title="$t('ser.as')"
                                  :edit-render="{name: '$input', props: {readonly: true}}" />
              </vxe-table>
            </div>
    ...
    <el-dialog :close-on-click-modal="false"
      ...
      <div class="maintenance-details">
        <vxe-table v-if="activeName === 'nippon' ||activeName === 'yuebao' || activeName === 'guarantee'"
                   ...
                   :mouse-config="{selected: true}"
                   :edit-config="{trigger: 'click', mode: 'row', showStatus: true}">
          <vxe-table-column sortable field="KEEP_CONTENT"
                            :title="$t('ser._1')"
                            :edit-render="{name: '$input', props: {readonly: true}}" />
          <vxe-table-column sortable field="KEEP_TOOLS"
                            :title="$t('ser._2')"
                            :edit-render="{name: '$input', props: {readonly: true}}" />
          <vxe-table-column sortable field="STATUS"
                            :title="$t('ser._3')">
          ...
          <vxe-table-column sortable field="MESSAGE"
                            :title="$t('ser._4')"
                            :edit-render="{name: '$input', props: {readonly: true}}" />
        </vxe-table>
      </div>
