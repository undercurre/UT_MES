              ...
              <div class="kanban-hour-yield-panel kanban-panel-bg"
                ...
                <div id="swiper1"
                  ...
                  <div class="block-center-content">
                    ...
                    >
                      <table class="ListTable table table-striped autoWidth"
...
export default {
  ...
  methods: {
    ...
    ESOPPreview () {
      ...
      console.log(this.ProductData.Wo_No)
      if (!this.ProductData.Wo_No) {
        this.$message({
          showClose: true,
          message: '对应料号+工序无SOP信息',
          type: 'error'
        })
        return
      }
    ...
    async enterChange (isBadCode) {
      ...
      this.SiteObj.data = this.InputData.toString()
      if (this.ProductData.Wo_No) {
    ...
    async getCollectProducts () {
      ...
      // 制成详细 子组件
      // this.getProcessDetsils(this.WoNoBer)
...
.CollectProducts {
  ...
  .collstat-form .result {
    ...
    font-size: 20px;
    /* height: 100px; */
    height: calc((100vh - 380px - 100px) / 2 - 14px);
    overflow: auto;
    background: #179415;
    border-radius: 6px;
  }
