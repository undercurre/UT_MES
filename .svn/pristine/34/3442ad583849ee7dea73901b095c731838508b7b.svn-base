...
<!--                  @keyup.enter.native="search_but" />-->
        <pn-no-select
          ...
          :multiple = false
          :placeholder-str="$t('SOPRoutes._2')"
        ></pn-no-select>
         <el-input v-model="formData.COLUMN_CODE"
                  style="width:100px"
                  :placeholder="$t('SOPRoutes._199')"
                  clearable
                  @input="search_but"
                  @keyup.enter.native="search_but" />
      ...
      ref="xTable"
        ...
        <el-table-column :show-overflow-tooltip="true"
         ...
         <el-table-column sortable min-width="140"
                         ...
                         prop="COLUMN_CODE"
                         :label="$t('SOPRoutes._199')"
                         align="center" />

        <el-table-column sortable min-width="140" :show-overflow-tooltip="true"
                          prop="PACKET_MARKING"
                          :label="$t('slw.t_6')"
                          align="center"
                           />

        <el-table-column sortable min-width="160"
                         :show-overflow-tooltip="true"
                         prop="PART_NO"
...
<!--                    :placeholder="$t('SOPRoutes._27')" />-->
          <pn-no-select
            :bind-data="copyVal.PART_NO_NEW"
            @getData = "setDialogCopyType1"
            :placeholder-str="$t('SOPRoutes._27')"
          >
          </pn-no-select>
        </el-form-item>
        <el-form-item :label="$t('SOPRoutes._26')"
...
<!--                  @keyup.enter.native="PartSearch" />-->
        <pn-no-select
          :bind-data="Partform.partNo"
          :placeholder-str="$t('mtf._86')"
          @getData = "setDialogCopyType2"
          @doWork = "makingWork"
          style="width:200px"
        >
        </pn-no-select>
...
export default {
  ...
  methods: {
    ...
    setDialogCopyType1 (val) {
      this.copyVal.PART_NO_NEW = val
    },
    setDialogCopyType2 (val) {
      this.Partform.partNo = val
    },
    makingWork (val) {
      this.Partform.partNo = val
      this.PartSearch()
