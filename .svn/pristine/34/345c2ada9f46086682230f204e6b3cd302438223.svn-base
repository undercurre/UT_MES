  ...
  <custom-container>
    ...
    <div class="table-container">
      <vxe-table
        ...
        :data="mainTable"
      >
        <vxe-table-column field="EQUIP_CODE" :title="$t('AviReport._1')" />
        <vxe-table-column field="POINT" :title="$t('AviReport._2')" />
        <vxe-table-column field="DESCRIPTION" :title="$t('AviReport._3')" />
        <vxe-table-column field="NUM" :title="$t('AviReport._4')" />
      </vxe-table>
    </div>
    <div class="report">
