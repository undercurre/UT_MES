      ...
      <el-col :span="12"
        ...
        <div class="SOPRoutes-row-table">
          <vxe-table ref="xTable"
            ...
            <vxe-table-column sortable :title="$t('SOPRoutes._64')"
                              type="radio"
                              min-width="70"
                              align="center" />
            ...
            <vxe-table-column sortable field="STANDARD_HUMAN"
                              :title="$t('SOPRoutes._67')"
                              :edit-render="{name: '$input', props: {type: 'number',min: '1'}}"
                              min-width="200"
                              align="center" />
            <vxe-table-column sortable field="STANDARD_WORK_FORCE"
        ...
        <el-tabs v-model="activeName"
          ...
          <el-tab-pane :label="$t('SOPRoutes._180')"
            ...
            <el-table v-if="activeName === 'operation'"
              ...
              <el-table-column sortable min-width="100"
                               ...
                               align="center" />
              <el-table-column sortable min-width="150"
                               prop="RESOURCE_NAME"
          ...
          <!-- <el-tab-pane :label="$t('SOPRoutes._81')" name="components" class="AddOrModify-row-tabs">
            ...
            >
              ...
              <el-table-column sortable prop="KEEP_CODE" :label="$t('SOPRoutes._83')" align="center" />
              <el-table-column sortable prop="KEEP_CODE" :label="$t('SOPRoutes._84')" align="center" />
              <el-table-column sortable prop="KEEP_CODE" :label="$t('SOPRoutes._85')" align="center" />
              <el-table-column sortable prop="KEEP_CODE" :label="$t('SOPRoutes._86')" align="center" />
              <el-table-column sortable prop="KEEP_CODE" :label="$t('SOPRoutes._87')" align="center" />
              <el-table-column sortable
