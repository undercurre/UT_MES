  ...
  <div class="AutomaticPackaging">
    ...
    >
      ...
      <el-row class="kanban-title">
        ...
        <el-col
          ...
          "
        >
          <div class="kanban-title-tab" style="padding-top: 10px">
      ...
      <div style="height: calc(100vh - 70px - 67px)">
        <el-row>
                  ...
                  >
                    ...
                    >
                      <div style="display: flex">
                        ...
                        />
                        <el-button type="primary" @click="EmptyClick">{{
                          $t("SfcsProductPallet.clean")
                        }}</el-button>
                      </div>
                    </el-form-item>
                    <el-form-item
                    ...
                    >
                      <div style="display: flex">
                        <el-input
                          ...
                          placeholder=" "
                        />
                        <el-button type="primary" @click="FullClick">{{
                          $t("CollectProducts._45")
                        }}</el-button>
                        <el-button type="primary" @click="ModifiesClick">{{
                          $t("CollectProducts._59")
                        }}</el-button>
                      </div>
                    </el-form-item>
                  </el-form>
              ...
              <div class="kanban-andon-call-panel kanban-panel-bg">
                <div class="block-center-content outcome">
                  <div style="margin-bottom: 10px; font-size: 20px">
                    {{ $t("CollectProducts._41") }}
                  </div>
                  <div class="result" v-if="ResultRun === 0">
                    <span>{{ InfRoute }}</span>
                  </div>
                  <!-- 警告 -->
                  <div
                  ...
                  <div
                    v-if="ResultRun === 2"
                    class="result"
                    style="background: #ef5757; color: #fce8bc"
                  >
                    <span>{{ InfRoute }}</span>
                  </div>
                </div>
          ...
          <el-col :span="9" style="padding-left: 15px; box-sizing: border-box">
            <!-- 产品数据 -->
            <div class="block-center">
              <div
              ...
              >
                ...
                <div class="block-center-content">
                  ...
                  <el-row :gutter="24" style="height: 85%">
                    <el-col :span="12" style="padding-top: 22px">
                      {{ $t("CollectProducts._9") }}：{{ ProductData.Part_No }}
                    </el-col>
                    <el-col :span="12" style="padding-top: 12px">
                      {{ $t("CollectProducts._68") }}：{{ ProductData.Wo_No }}
                    </el-col>
                    <el-col :span="24" style="padding-top: 12px">
                      {{ $t("CollectProducts._11") }}：{{ ProductData.Name }}
                    </el-col>
                    <el-col :span="24" style="padding-top: 12px">
                      {{ $t("CollectProducts._12") }}：{{
                        ProductData.Description
                      }}
                    </el-col>
                    <el-col :span="8" class="product-col product-row-col">
          ...
          <el-col :span="5" style="padding-left: 15px; box-sizing: border-box">
            <!-- 信息汇总 -->
            <div class="block-center">
              <div
                class="kanban-wo-site-panel kanban-panel-bg"
              ...
              >
                <div class="block-center-content">
                  <span style="font-size: 20px">{{
                    $t("CollectProducts._26")
                  }}</span>
                  <div class="content-history">
                    <div
                      class="content-history-list"
                      v-for="(item, index) in HistoricalData"
                      :key="index"
                    >
                      <div>SN：{{ item.SN_No }}</div>
                      <div>
                        {{ $t("CollectProducts._27") }}：
                        <span
                          v-if="item.Operation_Status == 'PASS'"
                          style="color: #179415"
                          >{{ item.Operation_Status }}</span
                        >
                        <span
                          v-else-if="item.Operation_Status == 'FAIL'"
                          style="color: #ef5757"
                          >{{ item.Operation_Status }}</span
                        >
                      ...
                      <div>
                        {{ $t("CollectProducts._28") }}：

                        {{ item.Operation_Time }}
                      </div>
                      <div>
                        {{ $t("CollectProducts._29") }}：{{ item.Operator }}
                      </div>
                    </div>
                  </div>
                </div>
                          ...
                          <div>
                            <el-form>
                              <el-row>
                                <el-col :span="12">
                                  <el-form-item
                                    :label="$t('homePage._13') + ':'"
                                    >{{ item.CALL_CODE }}</el-form-item
                                  >
                                  <el-form-item
                                    :label="$t('homePage._14') + ':'"
                                    >{{ item.LINE_TYPE }}</el-form-item
                                  >
                                  <el-form-item
                                    :label="$t('homePage._15') + ':'"
                                    >{{ item.OPERATION_NAME }}</el-form-item
                                  >
                                  <el-form-item
                                    :label="$t('homePage._16') + ':'"
                                    >{{ item.OPERATOR }}</el-form-item
                                  >
                                  <el-form-item
                                    :label="$t('homePage._17') + ':'"
                                  >
                                ...
                                <el-col :span="12">
                                  <el-form-item
                                    :label="$t('homePage._18') + ':'"
                                    >{{ item.CALL_CONTENT }}</el-form-item
                                  >
                                  <el-form-item
                                    :label="$t('homePage._19') + ':'"
                                    >{{
                                      item.OPERATION_LINE_NAME
                                    }}</el-form-item
                                  >
                                  <el-form-item
                                    :label="$t('homePage._20') + ':'"
                                    >{{
                                      item.OPERATION_SITE_NAME
                                    }}</el-form-item
                                  >
                                  <el-form-item
                                    :label="$t('homePage._21') + ':'"
                                    >{{ item.CREATE_TIME }}</el-form-item
                                  >
                                </el-col>
                              </el-row>
                            </el-form>
          ...
          <!--制程详细-->
          <el-col :span="4" style="padding-left: 15px; box-sizing: border-box">
              ...
              >
                ...
                >
                  <div class="block-center-content">
                    ...
                    >
                      <Manufacturing
                        :RouteId="this.ProductData.Route_Id"
    ...
    >
      ...
      <el-form ref="form" label-width="80px" size="small" label-position="top">
        <el-form-item :label="$t('CollectProducts._31')">
          ...
          >
            ...
            >
              <el-input
                v-model="WoNoFrom.WO_NO"
                @input="getOrder"
                @keyup.enter.native="getOrder"
                :placeholder="$t('CollectProducts._33')"
              ></el-input>
              <el-button
                type="primary"
                icon="el-icon-search"
      ...
      <span slot="footer" class="dialog-footer">
        ...
        <el-button type="primary" @click="dialogWoNo = false">
          {{ $t("_kanban._5") }}
        </el-button>
      </span>
    </el-dialog>
    ...
    >
      <el-form ref="form" label-width="80px" size="small" label-position="top">
        <el-form-item
          :label="$t('SfcsOperationSites._8')"
          prop="OPERATION_LINE_ID"
        >
          <el-select
            v-model="StationFrom.OPERATION_LINE_ID"
            style="width: 100%"
      ...
      <span slot="footer" class="dialog-footer">
        ...
        <el-button type="primary" @click="dialogStation = false">
          {{ $t("_kanban._5") }}
        </el-button>
      </span>
    </el-dialog>
    ...
    <el-dialog
      ...
      :close-on-click-modal="false"
    >
      <el-form ref="ModifiesRef" label-width="100px" :model="NewEdition">
        <el-form-item
          :label="$t('CollectProducts._61') + '：'"
          style="width: 50%"
        >
          <el-select
            v-model="NewEdition.SiteId"
            disabled
            :placeholder="$t('CollectProducts._36')"
            style="width: 100%"
          >
            <el-option
              v-for="(item, index) in StationtoList"
              :key="index"
              :label="item.OPERATION_SITE_NAME"
              :value="item.ID"
            ></el-option>
        ...
        <el-form-item
          :label="$t('SfcsContainerList._1') + '：'"
          style="width: 50%"
        >
          <div style="display: flex">
            <el-input
              v-model="NewEdition.SN"
              clearable
        ...
        <el-form-item
          :label="$t('SfcsContainerList._4') + '：'"
          style="width: 50%"
        >
          <div style="display: flex">
            <el-input
              v-model="NewEdition.CartonNo"
              type="text"
              disabled
              placeholder=" "
            />
            <el-button type="primary" @click="ModifiesFull">{{
              $t("CollectProducts._45")
            }}</el-button>
          </div>
        </el-form-item>
        <el-form-item
          :label="$t('SfcsContainerList._3') + '：'"
          style="width: 50%"
        >
          <el-input
            v-model="NewEdition.DEFINEDQTY"
            type="number"
            disabled
            placeholder=" "
          />
        ...
        <el-form-item
          :label="$t('SfcsContainerList._5') + '：'"
          style="width: 50%"
        >
          <el-input
            v-model="NewEdition.CURRENTQTY"
            type="number"
            disabled
            placeholder=" "
          />
      ...
      <div class="AutomaticPackaging-table">
        <vxe-table
          ...
          height="100%"
          :seq-config="{
            startIndex: (ModifiesFrom.Page - 1) * ModifiesFrom.Limit,
          }"
    ...
    <el-dialog
      ...
      :close-on-click-modal="false"
    >
      <el-form ref="DeleditRef" label-width="100px" :model="Deledit">
        <el-form-item :label="$t('CollectProducts._64') + '：'">
          <el-input
            v-model="Deledit.OldSN"
            type="text"
            disabled
            clearable
            style="width: 100%"
      ...
      <div slot="footer" style="text-align: center">
        ...
        <el-button type="primary" @click="DeleditsSub">
          {{ $t("_kanban._5") }}
        </el-button>
      </div>
    </el-dialog>
...
export default {
  ...
  methods: {
    ...
    async getLoadEarlyWarningData () {
      const res = await LoadEarlyWarningData({
    ...
    formatDate () {
      ...
      this.nowDate =
        `${year}` +
        this.$t('CollectProducts._38') +
        `${month}` +
        this.$t('CollectProducts._39') +
        `${day}` +
        this.$t('CollectProducts._40')
    ...
    async getSaveSite () {
      ...
      if (res.Result) {
        ...
        this.tableData = res.Result.collectDataViews
          ? res.Result.collectDataViews
          : []
    ...
    async enterChange (row) {
      ...
      this.SiteObj.carton.DefinedQty = Number(this.DefinedQty)
      // 工单号
      ...
      if (data) {
        ...
        if (data.printer) {
          if (data.printer.isPrint) {
            ...
            this.downSomething({
              PrintTaskId: data.printer.printTaskId,
      ...
      if (res.warnResult) {
        ...
        this.tableData = res.warnResult.collectDataViews
          ? res.warnResult.collectDataViews
          : []
      }
    },
    // 置满
    ...
    async DeleditsSub () {
      ...
      const res = await PackingModifyBySN(this.Deledit)
      if (res.Result) {
        this.UpdateCarton()
        this.$notify({
