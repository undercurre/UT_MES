...
// 根据员工工号获取对应的技能
export function GetEmployeeTrainGrade (query) {
  return request.get('Manager/GetEmployeeTrainGrade', {
    params: query
  })
}

// 保存员工技能分数
export function SaveEmployeeTrainGrade (data) {
  return request.post('Manager/SaveEmployeeTrainGrade', data)
}

// 删除员工技能
export function DeleteEmployeeTrainGrade (data) {
  // query string params方式请求
  return request.post('Manager/DeleteEmployeeTrainGrade', null, {
    params: {
...
export function GetParametersList (query) {
  return request.get('Common/GetParametersList', {
    params: query
  })
}
