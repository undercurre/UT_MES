  ...
  <custom-container>
    ...
    <div class="table-container">
      <vxe-table
        ...
        :data="mainTable"
      >
        <vxe-table-column sortable field="MACHINE" :title="$t('AoiReport._1')" />
        <vxe-table-column sortable field="PN" :title="$t('AoiReport._2')" />
        <vxe-table-column sortable field="ELEMENT_NAME" :title="$t('AoiReport._3')" />
        <vxe-table-column sortable field="ELEMENT_LOC" :title="$t('AoiReport._4')" />
        <vxe-table-column sortable field="NG_NAME" :title="$t('AoiReport._5')" />
        <vxe-table-column sortable field="NUM" :title="$t('AoiReport._6')" />
      </vxe-table>
    </div>
    <div class="report">
