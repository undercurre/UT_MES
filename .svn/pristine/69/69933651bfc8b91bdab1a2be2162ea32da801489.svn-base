  ...
  <d2-container>
    ...
    <div class="table-container">
      <vxe-table ref="xTable"
        ...
        <vxe-table-column sortable field="TOTABLE_NAME"
                          :title="$t('sql._3')"
                          :edit-render="{name: '$input', props: {readonly: true}}" />
        <vxe-table-column sortable field="DESC_CN"
                          :title="$t('sql._4')"
                          :edit-render="{name: '$input', props: {readonly: true}}" />
        <vxe-table-column sortable field="DESC_EN"
                          :title="$t('sql._5')"
                          :edit-render="{name: '$input', props: {readonly: true}}" />
        <vxe-table-column sortable field="USED_SEQUENCE"
                          :title="$t('sql._6')"
                          :edit-render="{name: '$input', props: {readonly: true}}" />
