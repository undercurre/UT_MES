  ...
  <custom-container>
    ...
    <div class="table-container">
      <vxe-table
        ...
        :data="mainTable"
      >
        <vxe-table-column sortable field="EQUIP_CODE" :title="$t('AviReport._1')" />
        <vxe-table-column sortable field="POINT" :title="$t('AviReport._2')" />
        <vxe-table-column sortable field="DESCRIPTION" :title="$t('AviReport._3')" />
        <vxe-table-column sortable field="NUM" :title="$t('AviReport._4')" />
      </vxe-table>
    </div>
    <div class="report">
...
import { GetAviDataAsync } from '@/api/Kanban'
export default {
  name: 'AviReport',
  components: {
  ...
  methods: {
    ...
    async getLoadData () {
      ...
      this.loading = true
      const res = await GetAviDataAsync(this.formData)
      ...
      if (res.Result) {
        ...
        errorCount.forEach((e) => {
          titles.push(e.POINT + '-' + e.DESCRIPTION)
          nums.push(e.NUM)
        })
