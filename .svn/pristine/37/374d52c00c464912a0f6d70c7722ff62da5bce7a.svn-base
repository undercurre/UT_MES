<template>
  <d2-container class="MesTongsInfo">
    ...
    <div class="MesTongsInfo-table-dev">
      <el-table
        ...
        <el-table-column sortable prop="CODE"
                         ...
                         width="200"
                         :show-overflow-tooltip="true" />
        <el-table-column sortable prop="MES_TONGS_TYPE"
                         :label="$t('mtf.t_4')"
                         align="center"
                         width="180"
                         :show-overflow-tooltip="true">
        ...
        <el-table-column sortable prop="TONGS_MODEL"
                         :label="$t('mtf._133')"
                         align="center"
                         width="120"
                         :show-overflow-tooltip="true" />
        <el-table-column sortable prop="SOURCES"
                         :label="$t('mtf.t_10')"
                         align="center"
                         width="120"
                         :show-overflow-tooltip="true">
        ...
        <el-table-column sortable prop="PRINCIPAL"
                         :label="$t('mtf._134')"
                         align="center"
                         width="120"
                         :show-overflow-tooltip="true" />
        <el-table-column sortable prop="STORE_CODE"
                         :label="$t('mtf.t_27')"
                         align="center"
                         width="120"
                         :show-overflow-tooltip="true" />
    ...
    <!-- 工装状态 -->
        <el-table-column sortable prop="TONGS_STATUS"
                         :label="$t('mtf._147')"
                         align="center"
                         width="150"
                         :show-overflow-tooltip="true">
        ...
        <!-- 是否ESD -->
        <el-table-column sortable prop="ISESD"
                         :label="$t('mtf._148')"
                         align="center"
                         width="120">
            <template slot-scope="scope">
        ...
        <el-table-column sortable prop="CREATE_USER"
                         ...
                         width="120"
                         :show-overflow-tooltip="true" />
        <el-table-column sortable prop="CREATE_DATE"
                         :label="$t('mtf.t_26')"
                         align="center"
                         width="180"
                         :show-overflow-tooltip="true" />
        ...
        <el-table-column sortable prop="UPDATE_USER"
                         ...
                         width="120"
                         :show-overflow-tooltip="true" />
        <el-table-column sortable prop="UPDATE_DATE"
                         :label="$t('mtf.t_29')"
                         align="center"
                         width="180"
                         :show-overflow-tooltip="true" />
    ...
    <el-tabs v-model="activeName"
      ...
      <el-tab-pane :label="$t('mtf.t2_1')"
        ...
        <el-table v-if="activeName === 'product'"
                  ...
                  height="100%"
                  highlight-current-row>
          <el-table-column sortable :label="$t('mtf.t_2')"
                           align="center"
                           width="110"
                           fixed="left"
                           :show-overflow-tooltip="true">
          ...
          <el-table-column sortable prop="PART_DESC"
                           ...
                           align="center"
                           :show-overflow-tooltip="true" />
          <el-table-column sortable prop="VERSION"
                           :label="$t('mtf.t2_6')"
                           align="center"
                           :show-overflow-tooltip="true" />
        </el-table>
      ...
      <el-tab-pane :label="$t('mtf.t3_2')"  name="productlist" class="MesTongsInfo-table-pane">
              <el-table v-if="activeName === 'productlist'" :header-cell-style="{ background: '#eef1f6', color: '#606266' }"
                ...
                <el-table-column sortable prop="FAMILY_NAME"
                                 :label="$t('mtf._138')"
                                 align="center"
                                 :show-overflow-tooltip="true" />
      ...
      <el-tab-pane :label="$t('mtf.t3_1')"
        ...
        <el-table v-if="activeName === 'operation'"
          ...
          <el-table-column sortable prop="OPERATION_TYPE"
                           :label="$t('mtf.t3_3')"
                           align="center"
                           :show-overflow-tooltip="true">
            <template slot-scope="scope">
          ...
          <el-table-column sortable prop="PRE_STATUS"
                           :label="$t('mtf.t3_14')"
                           align="center"
                           :show-overflow-tooltip="true">
            <template slot-scope="scope">
          ...
          <el-table-column sortable prop="LAST_STATUS"
                           :label="$t('mtf.t3_24')"
                           align="center"
                           :show-overflow-tooltip="true">
            <template slot-scope="scope">
          ...
          <el-col :span="12"
            ...
            <div class="MesTongsInfo-table-panege">
              <el-table v-if="activeName === 'activation'"
                ...
                <el-table-column sortable :label="$t('mtf.t_1')"
                                 fixed="left"
                                 width="100"
                                 align="center"
                                 :show-overflow-tooltip="true">
                ...
                <el-table-column sortable prop="TYPE"
                                 :label="$t('mtf.t4_3')"
                                 width="200"
                                 align="center"
                                 :show-overflow-tooltip="true">
                ...
                <el-table-column sortable prop="START_DATE"
                                 width="200"
                                 :label="$t('mtf.t4_10')"
                                 align="center"
                                 :show-overflow-tooltip="true" />
                <el-table-column sortable prop="MAINTAIN_USER"
                                 width="200"
                                 :label="$t('mtf.t4_11')"
                                 align="center"
                                 :show-overflow-tooltip="true" />
                <el-table-column sortable prop="END_DATE"
                                 width="200"
                                 :label="$t('mtf.t4_12')"
                                 align="center"
                                 :show-overflow-tooltip="true" />
          ...
          <el-col :span="12"
            ...
            <div class="MesTongsInfo-table-panege">
              <el-table v-if="activeName === 'activation'"
                ...
                <el-table-column sortable prop="ITEM_NAME"
                                 :label="$t('mtf.t4_14')"
                                 align="center"
                                 :show-overflow-tooltip="true" />
                <el-table-column sortable prop="ITEM_DESC"
                                 :label="$t('mtf.t4_15')"
                                 align="center"
                                 :show-overflow-tooltip="true" />
                <el-table-column sortable prop="ITEM_STATUS"
                                 :label="$t('mtf.t4_16')"
                                 align="center"
                                 :show-overflow-tooltip="true">
                  <template slot-scope="scope">
      ...
      <el-tab-pane :label="$t('mtf.t5_1')"
        ...
        <el-table v-if="activeName === 'service'"
          ...
          <el-table-column sortable prop="REPAIR_RESULT"
                           :label="$t('mtf.t5_2')"
                           align="center"
                           :show-overflow-tooltip="true">
            <template slot-scope="scope">
          ...
          <el-table-column sortable prop="REPAIRER"
                           :label="$t('mtf.t5_5')"
                           align="center"
                           :show-overflow-tooltip="true" />

          <el-table-column sortable prop="BEGIN_TIME"
                           :label="$t('mtf.t5_9')"
                           align="center"
                           :show-overflow-tooltip="true" />
          <el-table-column sortable prop="END_TIME"
                           :label="$t('mtf.t5_6')"
                           align="center"
                           :show-overflow-tooltip="true" />
          <el-table-column sortable prop="CREATE_USER"
        ...
        <div class="dialog-table">
          <el-table :header-cell-style="{ background: '#eef1f6', color: '#606266' }"
            ...
            <el-table-column sortable prop="PART_NO"
                             ...
                             align="center"
                             :show-overflow-tooltip="true" />
            <el-table-column sortable :label="$t('mtf.t_33')"
                             width="200"
                             align="center">
              <template slot-scope="scope">
                <el-button type="danger"
    ...
    <el-dialog v-dialogDrag
      ...
      <div class="fixture-table">
        <el-table :header-cell-style="{ background: '#eef1f6', color: '#606266' }"
          ...
          <!-- <el-table-column sortable prop="DESC" :label="$t('mtf.t3_18')" align="center" :show-overflow-tooltip="true" /> -->
          <el-table-column sortable prop="DESC"
                           :label="$t('mtf.t3_18')"
                           align="center">
            <template slot-scope="scope">
      ...
      <div class="StorageSpacesForm-Table">
        <vxe-table ref="StorageSpacesFormTable"
          ...
          <vxe-table-column sortable show-overflow
                            ...
                            width="96"
                            align="center" />
          <vxe-table-column sortable width="80"
                            :title="$t('se_cc.sn')"
                            fixed="left">
          ...
          <vxe-table-column sortable field="NAME"
                            :title="$t('mtf._92')"
                            :edit-render="{ name: '$input', props: { readonly: true } }" />
          <vxe-table-column sortable field="REMARK"
                            :title="$t('mtf._100')"
                            :edit-render="{ name: '$input', props: { readonly: true } }" />
        </vxe-table>
      </div>
          ...
          <el-tab-pane :label="$t('mtf._137')"
            ...
            <div class="dialog-table">
              <el-table :header-cell-style="{ background: '#eef1f6', color: '#606266' }"
                ...
                <!-- <el-table-column sortable prop="CUSTOMER"
                                 :label="$t('mtf._140')"
                                 align="center"
                                 :show-overflow-tooltip="true" /> -->
                <el-table-column sortable prop="PRODUCT_FAMILY_ID"
                                 label="ID"
                                 v-if="false"
                                 align="center"
