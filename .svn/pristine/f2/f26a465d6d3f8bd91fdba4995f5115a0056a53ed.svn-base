  ...
  <d2-container>
    <template slot="header">
      <custom-container-header exportMehodsName="exportData"
        ...
        <Pnselect :bindData = formData
                  :placeholder-str = "$t('as_cfe.ps')"
                  :list-query = "listQuery"
                  :customer-list = "customerList"
                  bindProp = "CATEGORY_ID"
                  @getbindData = "sameFormData"
                  @getbindList = "sameListData"
        ></Pnselect>
        <el-button type="primary"
                   icon="el-icon-search"
    ...
    <div class="table-container">
      <vxe-table ref="xTable"
        ...
        <vxe-table-column sortable field="MEANING"
                          ...
                          min-width="200"
                          :edit-render="{name: '$input', props: {readonly: true}}" />
        <vxe-table-column sortable field="STANDARD_TIME"
                          min-width="150"
                          :title="$t('as_cfe.tb_tm')"
                          :edit-render="{name: '$input', props: {readonly: true}}" />
        <vxe-table-column sortable field="STANDARD_FLAG"
                          min-width="180"
        ...
        <vxe-table-column sortable field="VALID_FLAG"
                          min-width="150"
        ...
        <vxe-table-column sortable field="EXPOSE_FLAG"
                          min-width="120"
...
import Pnselect from '@/components/Pnselect/index'
...
export default {
  ...
  methods: {
    sameFormData (bindData) {
      this.formData = bindData
    },
    sameListData (listData) {
