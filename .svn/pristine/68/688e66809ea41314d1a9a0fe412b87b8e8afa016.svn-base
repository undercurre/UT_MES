  ...
  <d2-container class="InspectionList">
    ...
    <div class="table-container">
      <el-table v-loading="listLoading"
        ...
        <el-table-column sortable prop="ORDER_ID"
                         :label="$t('IpqaConfig.InspectionList.sort')"
                         align="center" />
        <el-table-column sortable prop="IPQA_TYPE"
        ...
        <el-table-column sortable prop="ITEM_NAME"
                         ...
                         align="center"
                         :show-overflow-tooltip="true" />
        <el-table-column sortable prop="PROCESS_REQUIRE"
                         :label="$t('IpqaConfig.InspectionList.quality')"
                         align="center"
                         :show-overflow-tooltip="true" />
        <el-table-column sortable prop="REFERENCE_STANDARD"
        ...
        <el-table-column sortable prop="CREATETIME"
