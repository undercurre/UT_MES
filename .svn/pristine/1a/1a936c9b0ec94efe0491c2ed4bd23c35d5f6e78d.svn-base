  ...
  <d2-container>
    ...
    <el-row :gutter="20">
      ...
      <el-col :span="12" class="SfcsEquipContentConf-table">
        ...
        >
          <vxe-table-column sortable field="ORDER_NO" :title="$t('se_cc.sn')" />
          <vxe-table-column sortable field="RESOURCE_NAME" :title="$t('se_cc.rn')" />
          <vxe-table-column sortable field="RESOURCE_SIZE" :title="$t('se_cc.rs')">
            <template v-slot="{row}">{{row.RESOURCE_SIZE}}KB</template>
          </vxe-table-column>
          <vxe-table-column sortable  field="RESOURCE_SIZE" :title="$t('se_cc.operate')">
