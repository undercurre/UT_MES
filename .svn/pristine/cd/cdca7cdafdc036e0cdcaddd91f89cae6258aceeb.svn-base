<template>
  <d2-container>
    ...
    <div>
      ...
      >
        <vxe-table-column sortable min-width="150" field="CHECKER_BY" :title="$t('SmtFeederRepair._10')"  />
        <vxe-table-column sortable min-width="150" field="REPAIRER_BY" :title="$t('SmtFeederRepair._11')"  />
        <vxe-table-column sortable min-width="150" field="DEFECT_CODE" width="120" :title="$t('SmtFeederRepair._12')" />
        <vxe-table-column sortable min-width="150" field="REASON_CODE" width="150" :title="$t('SmtFeederRepair._13')" />
        <vxe-table-column sortable min-width="150" field="DAMAGE_PART" width="120" :title="$t('SmtFeederRepair._14')" />
        <vxe-table-column sortable min-width="150" field="REPAIR_ITEM" width="120" :title="$t('SmtFeederRepair._15')" />
        <vxe-table-column sortable min-width="150" field="METHOD" width="120" :title="$t('SmtFeederRepair._16')" />
        <vxe-table-column sortable min-width="150" field="DEFECT_TIME" width="150" :title="$t('SmtFeederRepair._17')" />
        <vxe-table-column sortable min-width="150" field="REPAIR_TIME" width="150" :title="$t('SmtFeederRepair._18')" />
        <vxe-table-column sortable min-width="150" field="RESULT" width="100" :title="$t('SmtFeederRepair._19')" />
        <vxe-table-column sortable min-width="150" field="FEEDER" width="120" :title="$t('SmtFeederRepair._20')" />
        <vxe-table-column sortable min-width="150" field="LINE_NAME" width="150" :title="$t('SmtFeederRepair._21')" />
      </vxe-table>
    </div>
      ...
      <div style="padding-left: 20px;padding-right: 20px">
        ...
        <div style="padding-top: 10px">
          ...
          >
            ...
            <vxe-table-column sortable :title="$t('SmtFeederRepair._1')" field="NAME" />
          </vxe-table>
        </div>
        <el-pagination
    ...
    >
      <div style="padding-left: 20px;padding-right: 20px">
        ...
        <div style="padding-top: 10px">
          ...
          >
            <vxe-table-column sortable type="radio" width="60" />
            <vxe-table-column sortable :title="$t('SmtFeederRepair._23')" field="CODE" />
            <vxe-table-column sortable :title="$t('SmtFeederRepair._24')" field="NAME" />
          </vxe-table>
        </div>
        <el-pagination
          style="margin-top: 20px"
