  ...
  <d2-container>
    ...
    <div class="table-container">
      ...
      >
        ...
        <vxe-table-column sortable field="VALUE" :title="$t('ssc._8')" :edit-render="{name: 'input'}" />
        <vxe-table-column sortable
          field="DESCRIPTION"
          :title="$t('ssc._20')"
        ...
        <vxe-table-column sortable :title="$t('plbd.tb_og')" width="120" align="center" fixed="right">
          <template v-slot="{ row }">
            <el-button
              type="danger"
