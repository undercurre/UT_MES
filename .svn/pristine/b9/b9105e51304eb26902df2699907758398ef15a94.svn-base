  ...
  <custom-container>
    ...
    <div class="table-container">
      <vxe-table
        ...
        :data="mainTable"
      >
        <vxe-table-column field="LOCATION" :title="$t('SpiReport._0')" />
        <vxe-table-column field="ERRCODE" :title="$t('SpiReport._1')" />
        <vxe-table-column field="NUM" :title="$t('SpiReport._2')" />
      </vxe-table>
    </div>
    <div class="report">
