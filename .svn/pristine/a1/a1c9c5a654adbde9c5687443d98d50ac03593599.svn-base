  ...
  <d2-container class="SfcsAllObjects">
    ...
    <div class="table-container">
      <vxe-table ref="xTable"
        ...
        <vxe-table-column sortable field="OBJECT_NAME"
                          :title="$t('sao._5')"
                          :edit-render="{name: 'input'}" />

        <vxe-table-column sortable field="OBJECT_MARK"
                          :title="$t('sao._6')"
                          :edit-render="{name: 'input'}" />
        <vxe-table-column sortable field="OBJECT_CATEGORY"
                          :title="$t('sao._7')"
                          :edit-render="{name: 'select', options: BjectCategoryListbox}" />
        <vxe-table-column sortable field="ISACTIVE"
                          :title="$t('sao._8')"
