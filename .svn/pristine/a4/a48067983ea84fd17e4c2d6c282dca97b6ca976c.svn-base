  ...
  <d2-container class="MaterialChangeRecord">
    ...
    <div class="table-container">
      <vxe-table ref="xTable"
        ...
        <vxe-table-column sortable field="ITEMCODE"
                          min-width="180"
                          :title="$t('MaterialChangeRecord._2')"
                          :edit-render="{ name: '$input', props: { readonly: true } }" />
        <vxe-table-column sortable field="PROJCODE"
                          min-width="220"
                          :title="$t('MaterialChangeRecord._3')"
                          :edit-render="{ name: '$input', props: { readonly: true } }" />
        <vxe-table-column sortable field="STAT"
                          min-width="180"
                          :title="$t('MaterialChangeRecord._4')"
                          :edit-render="{ name: '$input', props: { readonly: true } }" />
        <vxe-table-column sortable field="CDATA"
                          min-width="180"
                          :title="$t('MaterialChangeRecord._5')"
                          :edit-render="{ name: '$input', props: { readonly: true } }" />
        <vxe-table-column sortable field="DCNAME"
                          min-width="180"
                          :title="$t('MaterialChangeRecord._6')"
                          :edit-render="{ name: '$input', props: { readonly: true } }" />
        <vxe-table-column sortable field="BCCLAS"
                          min-width="180"
                          :title="$t('MaterialChangeRecord._7')"
                          :edit-render="{ name: '$input', props: { readonly: true } }" />
        <vxe-table-column sortable field="BCSPEC"
                          min-width="180"
                          :title="$t('MaterialChangeRecord._8')"
                          :edit-render="{ name: '$input', props: { readonly: true } }" />
        <vxe-table-column sortable field="BCMATERIAL"
                          min-width="180"
                          :title="$t('MaterialChangeRecord._9')"
                          :edit-render="{ name: '$input', props: { readonly: true } }" />
        <vxe-table-column sortable field="BCEXPANDS"
                          min-width="180"
                          :title="$t('MaterialChangeRecord._10')"
                          :edit-render="{ name: '$input', props: { readonly: true } }" />
        <vxe-table-column sortable field="BCSTRDEF15"
                          min-width="180"
                          :title="$t('MaterialChangeRecord._11')"
                          :edit-render="{ name: '$input', props: { readonly: true } }" />
        <vxe-table-column sortable field="BCSTRDEF18"
                          min-width="180"
                          :title="$t('MaterialChangeRecord._12')"
                          :edit-render="{ name: '$input', props: { readonly: true } }" />
        <vxe-table-column sortable field="BCSTRDEF19"
                          min-width="180"
                          :title="$t('MaterialChangeRecord._13')"
                          :edit-render="{ name: '$input', props: { readonly: true } }" />
        <vxe-table-column sortable field="ACNAME"
                          min-width="180"
                          :title="$t('MaterialChangeRecord._14')"
                          :edit-render="{ name: '$input', props: { readonly: true } }" />
        <vxe-table-column sortable field="ACCLAS"
                          min-width="180"
                          :title="$t('MaterialChangeRecord._15')"
                          :edit-render="{ name: '$input', props: { readonly: true } }" />
        <vxe-table-column sortable field="ACSPEC"
                          min-width="180"
                          :title="$t('MaterialChangeRecord._16')"
                          :edit-render="{ name: '$input', props: { readonly: true } }" />
        <vxe-table-column sortable field="ACMATERIAL"
                          min-width="180"
                          :title="$t('MaterialChangeRecord._17')"
                          :edit-render="{ name: '$input', props: { readonly: true } }" />
        <vxe-table-column sortable field="ACEXPANDS"
                          min-width="180"
                          :title="$t('MaterialChangeRecord._18')"
                          :edit-render="{ name: '$input', props: { readonly: true } }" />
        <vxe-table-column sortable field="ACSTRDEF15"
                          min-width="180"
                          :title="$t('MaterialChangeRecord._19')"
                          :edit-render="{ name: '$input', props: { readonly: true } }" />
        <vxe-table-column sortable field="ACSTRDEF18"
                          min-width="200"
                          :title="$t('MaterialChangeRecord._20')"
                          :edit-render="{ name: '$input', props: { readonly: true } }" />
        <vxe-table-column sortable field="ACSTRDEF19"
                          min-width="200"
