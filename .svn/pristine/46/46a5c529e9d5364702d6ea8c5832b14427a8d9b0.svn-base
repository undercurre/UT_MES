<template>
  <d2-container class="CallConfig">
    ...
    <div class="table-container">
      ...
      >
        <el-table-column sortable show-overflow-tooltip prop="LINE_ID_INCN" :label="$t('CallConfig._6')" align="center" />
        <el-table-column sortable show-overflow-tooltip prop="SITE_ID_INCN" :label="$t('CallConfig._7')" align="center" />
        <el-table-column sortable
          ...
          align="center"
        />
        <el-table-column sortable show-overflow-tooltip prop="ENABLED" :label="$t('CallConfig._9')" align="center">
