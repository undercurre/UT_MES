              ...
              <el-form-item :label="$t('srrr._20')">
                <el-radio-group v-model="verifyDate.RangerRuleType"
                  ...
                  <el-radio :disabled="disaRdaio"
                            label="1"
                            style="width: 50%; margin-bottom: 30px">{{ $t("srrr._22") }}</el-radio>
                  <el-radio label="0"
                            :disabled="disaRdaio"
                            style="width: 50%; margin-bottom: 30px">{{ $t("srrr._21") }}</el-radio>
                  <el-radio :disabled="disaRdaio"
                            label="2"
                            style="width: 50%; margin-bottom: 30px">{{ $t("srrr._23") }}</el-radio>
                  <el-radio :disabled="disaRdaio"
                            label="3"
                            style="width: 50%; margin-bottom: 30px">{{ $t("srrr._40") }}</el-radio>
                  <el-radio :disabled="disaRdaio"
                            label="4"
                            style="width: 50%">{{$t("srrr._45")}}</el-radio>
                </el-radio-group>
              </el-form-item>
            </el-col>
            <el-col :span="12">
    ...
    <div>
      <el-tabs v-model="activeName"
        ...
        <vxe-table v-loading="loading"
          ...
          <vxe-table-column sortable show-overflow
                            field="SORT_TYPE"
                            :edit-render="{ name: 'select', options: SortTypeListbox }"
                            :title="$t('srrr._51')"
                            align="center"
                            min-width="170" />
...
<!--          />-->
          ...
          <vxe-table-column sortable min-width="240"
                            show-overflow
