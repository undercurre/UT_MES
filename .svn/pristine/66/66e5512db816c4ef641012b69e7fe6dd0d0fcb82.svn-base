        ...
        <el-col :span="12"
          ...
          <div>
            <vxe-table ref="_xTable"
              ...
              <!-- <vxe-table-column sortable field="CATEGORY"
                                width="150"
              ...
              <vxe-table-column sortable field="UNIT_QTY"
                                ...
                                :class-name="comparisonIsOk"
                                :edit-render="{ name: '$input', props: { readonly: true } }" />
              <vxe-table-column sortable field="UNIT_CODE"
                                width="150"
        ...
        <el-col :span="12">
          ...
          <div class="table-container2"
            ...
            <vxe-table v-for="(topItem, topIndex) in fileDataCache"
                       ...
                       :radio-config="{ labelField: 'name', trigger: 'row' }"
                       :checkbox-config="{ checkField: 'checked', trigger: 'row' }">
              <vxe-table-column sortable v-for="(item, index) in topItem.TitleList"
                                :key="index"
                                :field="item.field"
                                min-width="160"
                                :title="item.fileName"
              ...
              <vxe-table-column sortable v-if="topItem.TitleList.length"
                                :class-name="comparisonIsOkRight"
...
export default {
  ...
  methods: {
    ...
    handleUploadRequest (data) {
      ...
      formdata.append('OldVersion', true)
