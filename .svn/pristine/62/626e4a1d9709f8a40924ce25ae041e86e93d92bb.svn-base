...
<!--                      </div>-->
<!--                    </el-select>-->
                    <PnNoSelect :bind-data="formData.PART_NO"
                                @getData = "setBindData"
                                :multiple = true
                    >
                    </PnNoSelect>
          ...
          <div style="height: 100%">
            ...
            >
              <el-table-column sortable
                ...
                :label="$t('_kanban._38')"
              />
              <el-table-column sortable min-width="120" prop="PASS" :label="'PASS'" />
              <el-table-column sortable min-width="120" prop="FAIL" :label="'FAIL'" />
              <el-table-column sortable
                min-width="120"
                prop="REPASS"
                :label="'REPASS'"
              ...
              <el-table-column sortable
                ...
                :label="'REFAIL'"
              />
              <el-table-column sortable min-width="120" prop="YIELD" :label="'YIELD'" />
              <el-table-column sortable min-width="120" prop="TOTAL" :label="'TOTAL'" />
            </el-table>
          </div>
        </el-tab-pane>
      ...
      <el-card class="box-card">
        ...
        >
          ...
          <el-table-column sortable
            ...
            :label="$t('_kanban._51')"
          />
          <el-table-column sortable min-width="100" prop="PASS" :label="'PASS'" />
          <el-table-column sortable min-width="100" prop="FAIL" :label="'FAIL'" />
          <!-- <el-table-column sortable
            min-width="120"
            prop="MODEL"
            :label="$t('_kanban._18')"
          /> -->
          <el-table-column sortable min-width="140" prop="REPASS" :label="'REPASS'" />
          <el-table-column sortable min-width="100" prop="REFAIL" :label="'REFAIL'" />
          <el-table-column sortable min-width="100" prop="YIELD" :label="'YIELD'" />
        </el-table>
      </el-card>
    </el-dialog>
  </d2-container>
