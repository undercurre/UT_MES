<template>
  <d2-container>
    ...
    >
      <el-form ref="editForm" label-width="120px" :model="editForm" :rules="addRules">
        <el-row>
          <el-col :span="8">
            <el-form-item :label="$t('AndonCallRuleConfig._15')" prop="LINE_ID">
              <el-select
                clearable
                style="width: 100%"
          ...
          <el-col :span="8">
            <el-form-item :label="$t('AndonCallRuleConfig._7')" prop="CALL_CATEGORY_CODE">
              <el-select
          ...
          <el-col :span="8">
            <el-form-item :label="$t('AndonCallRuleConfig._10')" prop="CALL_TYPE_CODE">
              <el-select
        ...
        <el-row>
          <el-col :span="8">
            <el-form-item :label="$t('AndonCallRuleConfig._13')" prop="CALL_TITLE">
              <el-select
                :disabled="
...
export default {
  ...
  data () {
    return {
      addRules: {
        LINE_ID: [{ required: true, message: '请选择线体', trigger: 'change' }],
        CALL_CATEGORY_CODE: [{ required: true, message: '请选择种类', trigger: 'change' }],
        CALL_TYPE_CODE: [{ required: true, message: '请选择类型', trigger: 'change' }],
        CALL_TITLE: [{ required: true, message: '请选择异常标题', trigger: 'change' }]
      },
      formData: {
        Page: 1,
        Limit: 15
  ...
  methods: {
    ...
    async changeCALL_CATEGORY_CODE (e) {
      ...
      // this.$forceUpdate()
      this.$set(this.editForm, 'CALL_TYPE_CODE', '')
    ...
    async changeCALL_TYPE_CODE (e) {
      ...
      // this.$forceUpdate()
      this.$set(this.editForm, 'CALL_TITLE', '')
